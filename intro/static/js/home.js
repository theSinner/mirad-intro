...
function imReady()
{
	...
	var temp=($('#connections-plate').parent().height()-60-$('#connections-plate').height()-$('#sponser').height()-$('#goAbout').height())
	$('#connections-plate').css({'margin-top':(temp*0.8/2).toString()+'px','margin-bottom':(temp*0.2/2).toString()+'px'});
